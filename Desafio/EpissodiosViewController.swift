...
class EpisodiosViewController: UIViewController {
    ...
    func configuraTableView() {
        episodioTableView.register(UINib(nibName: "EpisodioTableViewCell", bundle: nil), forCellReuseIdentifier: "EpisodioTableViewCell")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let celulaepi = tableView.dequeueReusableCell(withIdentifier: "EpisodioTableViewCell", for: indexPath) as? EpisodioTableViewCell else {fatalError("error to create cell")}
